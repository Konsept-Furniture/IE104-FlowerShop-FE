            ...
            <div className="grid w-full grid-cols-2 gap-10 sm:grid-cols-3 lg:grid-cols-3">
              ...
              <div className="flex flex-col items-center justify-center col-span-1">
                <div className="relative p-5">
                  ...
                  <img
                    className="relative z-20 w-full rounded-full"
                    src="https://scontent.fsgn2-5.fna.fbcdn.net/v/t39.30808-6/p640x640/228363066_1560039057690566_9073567168945264057_n.jpg?_nc_cat=102&ccb=1-5&_nc_sid=174925&_nc_ohc=w7f77GRwhk8AX8xDi6n&tn=zEvk5Tgx33hqijyg&_nc_ht=scontent.fsgn2-5.fna&oh=cdb2a6595eb98fe868f0cd4f9ed7585b&oe=61942CA2"
                  />
                </div>
                <div className="mt-3 space-y-2 text-center">
